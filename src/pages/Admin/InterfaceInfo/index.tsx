import CreateModal from '@/pages/Admin/CommonComponents/CreateModal';
import UpdateModal from '@/pages/Admin/CommonComponents/UpdateModal';
import {
  addInterfaceInfoUsingPost, deleteBatchInterfaceInfoUsingPost,
